...
@test_throws ErrorException AbstractState_set_cubic_alpha_C(inhandle, 0, "TWU", 0, 0, 0)
@test_throws ErrorException AbstractState_set_cubic_alpha_C(handle, 0, instr, 0, 0, 0)
